...
class MovieDirectorsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create movie_director" do
    assert_difference("MovieDirector.count") do
      post movie_directors_url, params: { movie_director: { birth_date: @movie_director.birth_date, movie_genre_id: @movie_director.movie_genre_id, name: @movie_director.name, nationality: @movie_director.nationality } }
    end
  ...
  test "should update movie_director" do
    patch movie_director_url(@movie_director), params: { movie_director: { birth_date: @movie_director.birth_date, movie_genre_id: @movie_director.movie_genre_id, name: @movie_director.name, nationality: @movie_director.nationality } }
